        ...
        <Router>
          <Route
            ...
            render={props => (
              <Diseases_Hint
                {...props}
                changeInformation={this.props.changeInformation}
              ...
              <Grid.Row>
                ...
                <Grid.Column>
                  <Form.Radio
                    label="yes"
                    value={true}
                    checked={this.state.whiteSkinCancer}
              ...
              <Grid.Row>
                ...
                <Grid.Column>
                  <Form.Radio
                    label="yes"
                    value={true}
                    checked={this.state.blackSkinCancer}
              ...
              <Grid.Row>
                ...
                <Grid.Column>
                  <Form.Radio
                    label="yes"
                    value={true}
                    checked={this.state.neurodermatitis}
              ...
              <Grid.Row>
                ...
                <Grid.Column>
                  <Form.Radio
                    label="yes"
                    value={true}
                    checked={this.state.highBloodPreasure}
