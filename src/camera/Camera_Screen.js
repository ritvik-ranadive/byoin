                ...
                return(
                    <div>
                        <Container textAlign='center'>
                            <Button basic color='yellow' circular floated='left' icon onClick={ this.handleBack }>
                                <Icon name='angle left'/>
                            </Button>
                            <Button basic color='yellow' circular floated='right' icon onClick={ this.handleHint }>
